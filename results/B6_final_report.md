...
> Доработанный отчет версии 2 без новых расчетов: [B6_final_report_v2.md](B6_final_report_v2.md).  
> Таблицы v2: [screening_unique_minima.csv](screening_unique_minima.csv), [best_B6_population.csv](best_B6_population.csv), расширенный [final_results.csv](final_results.csv).
